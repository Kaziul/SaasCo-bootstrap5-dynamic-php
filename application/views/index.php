    ...
    <header id="header-desc">
        <div class="container">
            <nav class="navbar navbar-expand-lg pt-3 pb-4  ">
                ...
                // }
                ?>
                <?php //print("<pre>".print_r($menus,true)."</pre>");  exit;
                ?>
                <a class="navbar-brand  my-3 pb-2" href="#"><img src="<?php echo base_url('/back-end/uploads/') . $header_elm['logo']; ?>" alt="logo"></a>
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav  mb-2 mb-lg-0 mt-2 ">
                        <?php foreach ($header_elm['menus'] as $valus) { ?>
                            <?php //print("<pre>".print_r($valus,true)."</pre>"); 
                            ?>
                            <li class="nav-item dropdown">
                                <a class="nav-link <?php if (!empty($valus->submenu)) {
                    ...
                    <a href="<?php //echo  $valu['btn_link']; 
                                ?>"><button type="button" class="btn btn-color-nav  "><?php echo  $header_elm['btn_txt']; ?>
                            <span class="grater "><i class="ml-3 <?php echo  $header_elm['btn_icon']; ?> "></i></span></button></a>
                </div>
            </nav>
